                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    // Adjust the while loop to remove the reference to product_id
                                                    while ($row = mysqli_fetch_assoc($result)) {
                                                        ...
                                                        // Remove the reference to product_id
                                                        echo "<td><a href='product_details.php?id=" . $row["title"] . "' class='btn btn-primary'>More Info</a></td>";
